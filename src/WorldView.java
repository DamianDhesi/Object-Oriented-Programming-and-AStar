...
public final class WorldView
{
    ...
    public void shift( int col, int row) {
        this.viewport.setCol(col);
        this.viewport.setRow(row);
    }

    public boolean contains( Point p) {
        return p.getY() >= this.viewport.getRow() && p.getY() < this.viewport.getRow() + this.viewport.getNumRows()
                && p.getX() >= this.viewport.getCol() && p.getX() < this.viewport.getCol() + this.viewport.getNumCols();
    }
